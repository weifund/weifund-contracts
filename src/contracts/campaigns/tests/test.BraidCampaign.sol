...
contract TestBraidCampaign_deployment is Test {
  ...
  function test_deployment() {
    ...
    assertEq(campaign.balanceOf(founders[0]), uint256(32394));
    assertEq(campaign.balanceOf(founders[1]), uint256(876));
    assertEq(campaign.totalSupply(), uint256(32394 + 876));
  }
}
...
contract TestBraidCampaign_contribution is Test {
  ...
  function test_3_approved_validContribution() {
    ...
    campaign.contributeMsgValue.value(uint256(10 ether))(emptyArray);
    assertEq(campaign.balanceOf(address(this)), uint256(10));
...
contract TestBraidCampaign_changePrice is Test {
  ...
  function test_5_approved_validContribution() {
    ...
    assertEq(beneficiary.balance, uint256(10 ether));
    campaign.contributeMsgValue.value(uint256(10 ether))(emptyArray);
    assertEq(campaign.balanceOf(address(this)), uint256(15));
...
contract TestBraidCampaign_capReach is Test {
  ...
  function test_1_approved_validContribution() {
    ...
    assertEq(campaign.tokensIssued(), uint256(10));
    assertEq(campaign.totalSupply(), uint256(10));
  }
  ...
  function test_2_approved_validContribution() {
    ...
    assertEq(beneficiary.balance, uint256(10 ether));
    campaign.contributeMsgValue.value(uint256(10 ether))(emptyArray);
    assertEq(campaign.balanceOf(address(this)), uint256(20));
    assertEq(beneficiary.balance, uint256(20 ether));

    assertEq(campaign.amountRaised(), uint256(20 ether));
    assertEq(campaign.stage(), uint256(0));
    assertEq(campaign.totalContributions(), uint256(2));
    assertEq(campaign.tokensIssued(), uint256(20));
    assertEq(campaign.totalSupply(), uint256(20));
  }
  ...
  function test_4_approved_validContribution() {
    ...
    assertEq(campaign.balanceOf(address(this)), uint256(30));
    ...
    assertEq(campaign.tokensIssued(), uint256(30));
    assertEq(campaign.totalSupply(), uint256(30));
  }
  ...
  function test_5_approved_validContribution() {
    ...
    assertEq(beneficiary.balance, uint256(40 ether));
    campaign.contributeMsgValue.value(uint256(20 ether))(emptyArray);
    assertEq(campaign.balanceOf(address(this)), uint256(40));
    ...
    assertEq(campaign.tokensIssued(), uint256(40));
    assertEq(campaign.totalSupply(), uint256(40));
  }
...
contract TestBraidCampaign_tokenManagement_postCampaign is Test {
  ...
  function test_2_shouldThrow_invalidTransfer() {
    campaign.transfer(address(beneficiary), 20);
  }

  function test_3_shouldThrow_invalidTransferFrom() {
    campaign.transferFrom(address(this), address(beneficiary), 20);
  }

  function test_4_shouldThrow_invalidApprove() {
    campaign.approve(address(beneficiary), 20);
  }
  ...
  function test_7_increaseBlockBy6000_goodTransfer() {
    ...
    campaign.transfer(address(beneficiary), 21);
    assertEq(campaign.balanceOf(beneficiary), uint256(21));
  }

  function test_8_goodTransferFrom() {
    assertEq(block.number > campaign.freezePeriod(), true);
    assertEq(campaign.balanceOf(tokenUser), uint256(0));
    assertEq(campaign.balanceOf(tokenUser2), uint256(0));
    campaign.approve(address(tokenUser), 12);
    tokenUser.transferFrom(address(campaign), address(this), address(tokenUser2), 5);
    assertEq(campaign.balanceOf(tokenUser), uint256(0));
    assertEq(campaign.balanceOf(tokenUser2), uint256(5));
    assertEq(campaign.balanceOf(beneficiary), uint256(21));
    tokenUser.transferFrom(address(campaign), address(this), address(tokenUser), 7);
    assertEq(campaign.balanceOf(tokenUser), uint256(7));
  }
}
...
contract TestBraidCampaign_fullCampaign_withSuccessTransfers is Test {
  ...
  function test_1_contribution() {
    ...
    assertEq(campaign.balanceOf(address(contributor1)), uint256(1000));
  ...
  function test_2_contribution() {
    ...
    assertEq(campaign.balanceOf(address(contributor2)), uint256(5000));
  ...
  function test_3_contribution() {
    ...
    assertEq(campaign.balanceOf(address(contributor3)), uint256(2001));
  ...
  function test_4_contribution() {
    ...
    assertEq(campaign.balanceOf(address(contributor4)), uint256(10));
  ...
  function test_6_contribution() {
    ...
    assertEq(campaign.balanceOf(address(contributor5)), uint256(10000));
  ...
  function test_7_contribution_secondContribution() {
    ...
    assertEq(campaign.balanceOf(address(contributor3)), uint256(2001 + 1000));
  ...
  function test_9_contribution() {
    ...
    assertEq(campaign.balanceOf(address(contributor1)), uint256(1000 + 50));
  ...
  function test_9d_contribution_hitCap() {
    ...
    uint256 remainingContributionToCap = leftOverTokens * campaign.price();
    contributor1.contributeMsgValueFallback(address(campaign), remainingContributionToCap);
    assertEq(campaign.balanceOf(address(contributor1)), uint256(1000 + 50 + leftOverTokens));
  ...
  function test_9k_1_validTransferAndApprove_increaseBlockBy6000() {
    assertEq(block.number > campaign.freezePeriod(), true);
    assertEq(campaign.stage(), uint256(2));
    assertEq(campaign.balanceOf(address(tokenUser)), uint256(0));
    contributor1.transfer(address(campaign), address(tokenUser), 30);
    assertEq(campaign.balanceOf(address(tokenUser)), uint256(30));
    contributor2.approve(address(campaign), address(tokenUser2), 50);
    tokenUser2.transferFrom(address(campaign), address(contributor2), address(tokenUser), 10);
    assertEq(campaign.balanceOf(address(tokenUser)), uint256(40));
  }
}
